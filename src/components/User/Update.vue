...
export default {
    ...
    methods:{
        ...
        prepareFormMetadata() {
            ...
            this.form.metadata ??= {
                custom_fields: [{ title: "Telefono", value: "" }]
            };

            if (isObject(this.form.metadata.custom_fields)) {
                this.form.metadata.custom_fields = Object.entries(this.form.metadata.custom_fields).map(
